...
public class DBElectricity {

    private static final String TAG = "DBElectricity";
    ...
    public static final String DATABASE_NAME = "Electricity";
    ...
    private DBElectricity.DatabaseHelper myDBHelper;

    private SQLiteDatabase db;

    public DBElectricity(Context ctx){

        this.context = ctx;

        myDBHelper = new DBElectricity.DatabaseHelper(context);
    }

    //open the database connection

    public DBElectricity open(){
