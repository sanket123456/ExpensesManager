...
public class DBMobile {
    ...
    private static final String TAG = "DBMobile";
    ...
    private DBMobile.DatabaseHelper myDBHelper;

    private SQLiteDatabase db;

    public DBMobile(Context ctx){

        this.context = ctx;

        myDBHelper = new DBMobile.DatabaseHelper(context);
    }

    //open the database connection

    public DBMobile open(){
