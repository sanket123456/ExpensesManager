...
public class DBShopping {
    ...
    private static final String TAG = "DBShopping";
    ...
    private DBShopping.DatabaseHelper myDBHelper;

    private SQLiteDatabase db;

    public DBShopping(Context ctx){

        this.context = ctx;

        myDBHelper = new DBShopping.DatabaseHelper(context);
    }

    //open the database connection

    public DBShopping open(){
