...
public class DBOthers {
    ...
    private static final String TAG = "DBOthers";
    ...
    public static final String DATABASE_NAME = "others";
    ...
    private DBOthers.DatabaseHelper myDBHelper;

    private SQLiteDatabase db;

    public DBOthers(Context ctx){

        this.context = ctx;

        myDBHelper = new DBOthers.DatabaseHelper(context);
    }

    //open the database connection

    public DBOthers open(){
